...
[![版本](https://img.shields.io/badge/版本-0.4.0-blue.svg)](https://github.com/DEVILENMO/EndstoneMC-ARC-Button-Shop-Plugin)
...
- **弧光背包管理器**: 优先使用独立插件 `arc_inventory`；未安装时回退本包内嵌 `InventoryManager`
- **自动交易**: 安全的资金转账和物品交换
- **防作弊**: 严格的交易验证和错误处理
- **多货币支持**: 支持服务器自定义货币系统
